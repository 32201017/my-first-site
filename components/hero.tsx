...
export function Hero() {
  ...
  const defaultInfo = {
    greeting: "도시계획부동산학부 재학생",
    name: "김조은",
    title: "도시계획과 부동산의 융합",
    description: "도시의 미래 가치를 창출하는 전문 인재로 성장하기 위해 이론과 실무를 균형 있게 탐구하고자 합니다. 특히 도시계획과 부동산 금융의 융합적 시각을 기반으로 지속가능한 개발 방향을 제시할 수 있는 분석 역량을 키우겠습니다. 나아가 지역사회와 산업 전반에 기여하는 실질적 해결책을 제시하는 전문가가 되는 것을 목표로 합니다.",
    profileImage: "/uploads/hero-profile-1765033350757.png",
    backgroundImage: "",
    backgroundVideo: "",
    backgroundOpacity: 0.1,
    projectButton: "프로젝트",
    background: {"image":"/uploads/hero-background-1765033379507.jpg","video":"","color":"","opacity":0.5}
  }
