...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교","period":"2020 ~ 2025","description":"도시계획부동산학부 부동산학전공"},{"icon":"graduation","title":"서울대학교 환경대학원","period":"2026 ~","description":"도시계획학과 도시및지역계획학전공"},{"icon":"briefcase","title":"미래에셋증권 (프로젝트금융 1본부 2팀)","period":"2023","description":"인턴"},{"icon":"briefcase","title":"한국자산신탁 (신탁부문 사업2본부 1팀","period":"2024 ~ 2025","description":"인턴"}],
    skills: [{"icon":"code","title":"실무 기반의 분석·문제해결 능력","description":"미래에셋증권과 한국자산신탁 인턴 경험을 통해 금융·부동산 실무를 직접 경험하며 데이터 분석, 리스크 파악, 실무 문서 작성 등 실질적인 문제해결 역량을 갖추었습니다."},{"icon":"users","title":"우수한 협업 및 커뮤니케이션 능력","description":"대학에서 다수의 팀 프로젝트를 수행하고 대의원 활동을 통해 다양한 이해관계자와 소통·조율한 경험이 있어 조직 내 협업 능력과 의견을 조율하는 커뮤니케이션 역량이 뛰어납니다."},{"icon":"rocket","title":"글로벌 마인드와 적응력","description":"일본·미국 등 여러 나라로의 해외 경험을 통해 새로운 환경에 빠르게 적응하고 다양한 관점을 수용하는 능력을 갖추었으며, 이를 문제해결과 기획 능력에 자연스럽게 연결할 수 있습니다."},{"icon":"star","title":"적극적이고 주도적인 리더십","description":"대의원 활동, 동아리 운영 경험을 통해 조직 활동을 스스로 이끌고 책임 있게 수행하는 태도를 길렀으며, 프로젝트나 업무에서 주도적으로 방향을 제시하는 리더십을 보유하고 있습니다"}],
    storyTitle: "나의 이야기",
    story: ["도시계획/부동산학을 전공하며 이론과 실무를 균형 있게 배우고자 노력하였습니다. 공간 구조와 도시 시스템에 대한 학문적 토대를 학습하는 동시에, 실제 부동산 시장과 정책이 도시계획과 어떻게 맞물려 작동하는지를 이해하고자 다양한 수업과 프로젝트에 참여했습니다. 이를 통해 단순한 개발을 넘어 도시의 지속가능성과 지역 균형발전에 기여할 수 있는 계획적 사고를 키우는 데 주력하였습니다.","다양한 인턴 경험은 도시와 부동산 문제를 단순히 공급과 수요의 관점에서만 볼 수 없으며, 인구구조 변화와 지역경제 여건을 종합적으로 고려해야 한다는 사실을 깨닫게 해주었습니다. 나아가 이러한 구조적 문제를 해결하기 위해 어떠한 계획적·정책적 접근이 가능할지 깊이 고민하게 되었습니다.","이러한 학습과 경험은 저에게 학문적 탐구와 실무적 실행을 잇는 관점을 형성해 주었고, 대학원에서 정책·제도 분석 역량을 심화해 지속 가능한 도시 발전의 대안을 모색하고자 하는 동기로 이어졌습니다."],
    storyImage: "/uploads/about-image-1765034995083.jpg",
    hobbies: ["📚 독서","✈️ 여행","🎮 게임","🚴 자전거","🎵 음악 감상"]
  }
